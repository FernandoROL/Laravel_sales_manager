            ...
            <td class="container"
                ...
                <div class="content"
                    ...
                    <span class="preheader"
                        style="color: transparent; display: none; height: 0; max-height: 0; max-width: 0; opacity: 0; overflow: hidden; mso-hide: all; visibility: hidden; width: 0;">Receipt</span>
                    <table role="presentation" border="0" cellpadding="0" cellspacing="0" class="main"
                        ...
                        <tr>
                            <td class="wrapper"
                                ...
                                valign="top">
                                <h1
                                    style="font-family: Helvetica, sans-serif; font-weight: normal; margin: 0; margin-bottom: 16px;">
                                    Email Receipt</h1>
                                <p
                                    style="font-family: Helvetica, sans-serif; font-size: 16px; font-weight: normal; margin: 0; margin-bottom: 24px;">
                                    Hi there, {{ $mailData['clientName'] }}!</p>
                                <p
                                    style="font-family: Helvetica, sans-serif; font-size: 16px; font-weight: normal; margin: 0; margin-bottom: 12px;">
                                    Your purchase was complete!</p>
                                <p
                                    style="font-family: Helvetica, sans-serif; font-size: 16px; font-weight: normal; margin: 0; margin-bottom: 12px;">
                                    Product purcheased - {{ $mailData['productName'] }}</p>
                                <p
                                    style="font-family: Helvetica, sans-serif; font-size: 10px; font-weight: normal; margin: 0; margin-bottom: 5px; color: rgba(0, 0, 0, .50)">
